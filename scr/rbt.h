...
/**
 * @namespace RBT
 * @brief A set of useful functions for manipulating an RBT tree type
 */
namespace RBT{
    ...
    /**
     * @brief A function for insert node in the Binary tree. Taking care with the RBT conditions (like the colors).
     ...
     * @details There are important differences in insertion compared to other types of Trees (BST, AVL)
     ...
     * @details There aren't difference between this function with the function in BST and AVL
     * @return A structure of type InsertResult, with parameters like: found, documentIds, executionTime, numComparisons.
     * There are too Pointers like: resultedNode, parent
     */
